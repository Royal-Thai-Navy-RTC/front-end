...
export default function RegisterSoldier() {
    ...
    const getValueWithOther = (name) => {
        if (formValues[name] === "อื่นๆ") {
            return formValues[`${name}_other`] || "";
        }
    ...
    const handleRegister = async () => {
        ...
        if (missing.length) {
            Swal.fire({
                ...
                text: `ฟิลด์ที่ยังว่าง: ${missing.join(", ")}`
            });
            return; // หยุด submit ถ้ามี missing
        }
        ...
        try {
            ...
            if (formValues.bloodGroup) fd.append("bloodGroup", formValues.bloodGroup);
            ...
            // append พวก select + "อื่นๆ" หลังเช็ค missing
            fd.append("education", getValueWithOther("education"));
            fd.append("emergencyName", getValueWithOther("emergencyName"));
            fd.append("previousJob", getValueWithOther("previousJob"));
            fd.append("religion", getValueWithOther("religion"));
    ...
    const profileSections = [
        {
            ...
            fields: [
                ...
                { name: "bloodGroup", label: "กรุ๊ปเลือด", type: "select", option: bloodOptions, },
        ...
        },
        {
            ...
            fields: [
                { name: "emergencyName", label: "ชื่อผู้ติดต่อฉุกเฉิน", type: "select", option: relationOptions },
