...
/**
 * NOTE:
 * defaultIdCard points to a local file uploaded earlier in this session.
 * Developer instruction: send the local path as URL. This path will be transformed
 * by the environment into a usable URL.
 */
const defaultIdCard = "/mnt/data/800cc68f-0471-4b9d-bb61-a4e823e7822c.png"; // <-- local file path from session
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-1/3 bg-white rounded-2xl shadow p-4 flex flex-col items-center gap-4">
            ...
            <div
              className="w-full h-44 rounded-xl border-2 border-dashed border-gray-300 bg-gray-100 flex items-center justify-center overflow-hidden cursor-pointer"
              onClick={() => fileInputRef.current?.click()}
            >
              {avatarPreview || formValues.avatar || defaultIdCard ? (
                <img
                  alt="id preview"
            ...
            <div className="w-full text-sm text-gray-500 mt-2">
              (แนะนำอัตราส่วนสี่เหลี่ยมสำหรับบัตร เช่น 4:3 — ระบบจะปรับขนาดอัตโนมัติ)
            </div>
          </div>
          ...
          <div className="lg:flex-1 bg-white rounded-2xl shadow p-6">
            <div className="space-y-6">
              ...
              <div className="border border-gray-200 rounded-xl p-4">
                ...
                {/* chronicDiseases */}
                <div className="grid sm:grid-cols-2 gap-4 items-end mb-3">
                  <div>
              ...
              <div className="flex justify-end">
                ...
                >
                  {loading ? "กำลังบันทึก..." : "บันทึกข้อมูลทหาร"}
                </button>
              </div>
            </div>
          </div>
