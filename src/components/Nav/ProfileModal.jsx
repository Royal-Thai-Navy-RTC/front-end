...
export default function ProfileModal({
  ...
  const avatarSrc = (() => {
    if (!profileForm?.avatar) return navy;
    const baseAvatar = resolveAvatarUrl(profileForm.avatar) || navy;
    const version = avatarVersion ?? 0;
    return `${baseAvatar}?v=${version}`;
  })();
              ...
              >
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {section.fields.map((field, fieldIndex) => (
                    <label
                      key={`${section?.key || section?.title || section.name || sectionIndex}-${field.name}-${fieldIndex}`}
                    ...
                    >
                      ...
                      {field.type === "select" ? (
                        ...
                        <input
                          ...
                          value={
                            field.type == "date"
                              ? profileForm[field.name]?.split("T")[0]
            ...
            <div className="border border-gray-200 rounded-2xl p-4 shadow-sm flex flex-col gap-4">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  เพื่อความปลอดภัย กรุณาตั้งรหัสผ่านใหม่ที่คาดเดายาก
                </p>
              </div>
