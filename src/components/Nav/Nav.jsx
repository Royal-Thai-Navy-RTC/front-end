  ...
  const profileSections = [
    ...
    },
    {
      title: "ข้อมูลเพิ่มเติม", fields: [
        ...
        { name: "specialSkills", label: "ความสามารถพิเศษ", type: "text", placeholder:"ระบุ เช่น ว่ายน้ำ, ภาษาอังกฤษ" },
        { name: "secondaryOccupation", label: "อาชีพเสริม", type: "text",placeholder:"ระบุอาชีพเสริม เช่น ช่างภาพ, นักเขียน" },
        { name: "chronicDiseases", label: "โรคประจำตัว", type: "text",placeholder:"ระบุโรคประจำตัว เช่น ความดัน, เบาหวาน" },
        { name: "drugAllergies", label: "แพ้ยา", type: "text",placeholder:"ระบุยาที่แพ้ เช่น Sulfa, Pennicillin" },
        { name: "foodAllergies", label: "แพ้อาหาร", type: "text",placeholder:"ระบุอาหารที่แพ้ เช่น กุ้ง, ถั่ว" },
